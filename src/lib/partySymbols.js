...
const PARTY_SYMBOLS = {
  ...
  ADMK:   { name: 'Two Leaves',              symbolUrl: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'%3E%3Ccircle cx='32' cy='32' r='30' fill='%23d81b2a'/%3E%3Cpath d='M33 19c-5 7-12 14-11 23 1 6 5 11 11 11s10-5 11-11c1-9-6-16-11-23z' fill='%23109d47' stroke='%23000' stroke-width='2' stroke-linejoin='round'/%3E%3Cpath d='M31 19c5 7 12 14 11 23-1 6-5 11-11 11s-10-5-11-11c-1-9 6-16 11-23z' fill='%2342c04c' stroke='%23000' stroke-width='2' stroke-linejoin='round'/%3E%3C/svg%3E", favicon: 'https://www.aiadmk.com/favicon.ico' },
